...
final public class BrowserFactory {
    ...
    private static String downloadFileDir = userDir + new PropertiesResourceManager("project.properties").getProperty("dirSaveDonwloadedFiles");
...
//        }
    ...
    private static RemoteWebDriver getFirefoxDriver(DesiredCapabilities capabilities) {
        ...
        ffProfile.setPreference("browser.download.dir", downloadFileDir);
        ffProfile.setPreference("browser.helperApps.neverAsk.saveToDisk", "application/x-debian-package;application/octet-stream");
    ...
    private static RemoteWebDriver getChromeDriver(Proxy proxy) {
        ...
        prefs.put("download.default_directory", downloadFileDir);
